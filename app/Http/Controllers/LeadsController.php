...
class LeadsController extends Controller
{
    ...
    public function addlead(Request $req)
    {
        ...
        return redirect()->route('leads.filter', 'new')->with('success', 'Все в порядке, лид добавлен');
    }
    ...
    public function leadDelete($id, Request $req)
    {
        ...
        return redirect()->route('leads.filter', 'new')->with('success', 'Все в порядке, лид удален');
    }
    ...
    public function leadFail($id, Request $req)
    {
        ...
        return redirect()->route('leads.filter', 'new')->with('success', 'Лид перемещен в проваленные. Его можно будет обработать потом.');
    }
}
