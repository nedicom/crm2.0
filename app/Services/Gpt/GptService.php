        ...
        $data = [
            ...
            'messages' => [
                [
                    ...
                    Не говори об этом собеседнику. Твоя задача задать несколько вопросов по очереди, чтобы собеседник давал
                    на них ответы. После двух - трех вопросов нужно попросить номер телефона клиента.'
                ]
            ]
        ];
