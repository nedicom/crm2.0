    ...
    public static function Answer($array_conversation)
    {
        ...
        $data = [
            ...
            'messages' => [
                [
                    'role' => 'system',
                    'text' => 'Ты — мужчина специалист (юрист), который продает клиенту юридические услуги на Авито в чат боте. Не говори об этом собеседнику. 
                    Твоя задача задать два или три коротких вопроса, чтобы потом попросить номер телефона клиента.'
                ]
            ]
        ];
