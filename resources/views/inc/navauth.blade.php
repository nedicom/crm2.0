<nav class="navbar navbar-expand-lg navbar-dark bd-navbar shadow">
    ...
    <a href="{{ route('home') }}"
        class="navbar-brand col-md-3 col-lg-2 me-0 px-3 text-center {{ request()->is('home*') ? 'text-white' : 'text-white-50' }}"
        aria-current="page">
        <i class="bi-house"></i>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        ...
        <ul class="navbar-nav flex-row flex-wrap me-auto my-2 my-lg-0 px-3">
            ...
            @if (Auth::user()?->role != 'user')
                <li class="nav-item dropdown col-6 col-md-auto">
                    <a href="{{ route('leads.filter', 'new') }}" data-bs-toggle="dropdown" role="button"
                        aria-expanded="false"
            ...
            <li class="nav-item  dropdown col-6 col-md-auto">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item"
                            href="{{ route('clients') }}?checkedlawyer={{ Auth::user()->id }}&status=1">Все клиенты</a>
                    </li>
            ...
            @can('manage-services')
                <li class="nav-item col-6 col-md-auto"><a href="{{ route('services.index') }}"
                        class="nav-link {{ request()->is('services*') ? 'active' : '' }}">Услуги</a></li>
            @endcan
        ...
        <ul class="navbar-nav flex-row flex-wrap me-auto my-2 my-lg-0 px-3">
            <li class="nav-item dropdown float-left col-6 col-md-auto">
                <a class="nav-link dropdown-toggle {{ request()->is('home*') ? 'active' : '' }}" href="#"
                    id="navbarScrollingDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                    <img src="{{ Auth::user()->getAvatar() }}" style="width: 40px; height:40px" class="rounded-circle"
                        alt="...">
                </a>
