...
@section('main')
    ...
    <div class="tab-content" id="pills-tabContent">
        ...
        <div class="tab-pane fade show active" id="pills-newleads" role="tabpanel" aria-labelledby="pills-newleads-tab">
            <p class="row font-weight-light bg-white p-3 shadow">Сюда поступают новые лиды. Нужно зайти в карточку лида и
        ...
        <div class="tab-pane fade" id="pills-consleads" role="tabpanel" aria-labelledby="pills-consleads-tab">
            <p class="row font-weight-light bg-white p-3 shadow">Тут лиды с задачей - консультация и любым статусом кроме
                "выполнена"</p>
            <div class="row">
        ...
        <div class="tab-pane fade" id="pills-phoneleads" role="tabpanel" aria-labelledby="pills-phoneleads-tab">
            <p class="row font-weight-light bg-white p-3 shadow">Тут лиды с задачей - Звонок и любым статусом кроме
                "выполнена"</p>
            <div class="row">
        ...
        <div class="tab-pane fade" id="pills-defeatleads" role="tabpanel" aria-labelledby="pills-defeatleads-tab">
            <p class="row font-weight-light bg-white p-3 shadow">Тут мусорные лиды - дубли, спам звонки, ошиблись номером и
        ...
        <div class="tab-pane fade" id="pills-withoutcaseleads" role="tabpanel"
            ...
            <p class="row font-weight-light bg-white p-3 shadow" style="font-size:12px">Тут лиды без консультаций, звонков
        ...
        <div class="tab-pane fade" id="pills-winleads" role="tabpanel" aria-labelledby="pills-winleads-tab">
            <p class="row font-weight-light bg-white p-3 shadow">Тут результат работы отдела продаж за последние 2 месяца
            </p>
            <div class="row">
